...
//#cgo linux LDFLAGS: -fPIC -L. -L${SRCDIR}/api/v6.3.6_20160606_api_tradeapi_linux64 -Wl,-rpath=${SRCDIR}/api/v6.3.6_20160606_api_tradeapi_linux64  -lthostmduserapi -lthosttraderapi -lstdc++
//#cgo linux CPPFLAGS: -fPIC -I. -I/${SRCDIR}/api/v6.3.6_20160606_api_tradeapi_linux64/
import "C"
